...
export const NewsAside: React.FC = () => {
    ...
    return (
        <section className="flex flex-col px-4 py-3.5  lg:w-[288px] lg:mx-0 mx-[20px]  w-full bg-white rounded-lg shadow-[0px_0px_11px_rgba(101,101,101,0.12)] max-md:mt-6">
            ...
            <div>
                {newsItems.map((item, index) => (
                    <div
                        key={index}
                        className="flex flex-col py-3 w-full border-b border-gray-200"
                    >
