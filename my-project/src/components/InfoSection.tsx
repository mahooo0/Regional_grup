        ...
        return (
            <section className="mt-[220px] relative ">
                <div className=" flex lg:flex-row md:flex-row sm:flex-row flex-col lg:justify-end  md:justify-end justify-start gap-6 ">
                    ...
                    <div
                        data-aos="fade-left"
                        className="  border-b-[6px] border-[#2758A3]  lg:w-1/2 md:w-1/2 sm:1/2 w-full   h-fit"
                    >
                        <img src="/svg/cater.svg" alt="" />
                    </div>
                </div>
                <div className="flex justify-center px-[auto] mt-[54px]">
                    <div className="flex flex-wrap gap-10 items-start justify-center self-start mt-14  max-md:mt-10 max-md:max-w-full">
                        <img
                            loading="lazy"
        ...
        return (
            <section className="mt-[220px] relative  ">
                <div className=" flex lg:flex-row-reverse md:flex-row-reverse sm:flex-row-reverse flex-col lg:justify-end  md:justify-end justify-start gap-6">
                    ...
                    <div
                        data-aos="fade-right"
                        className=" border-b-[6px] border-[#2758A3]  lg:w-1/2 w-full flex justify-end  h-fit"
                    >
                        <img src="/svg/cater.svg" alt="" />
                    </div>
                </div>
                <div className="flex justify-center px-[auto] mt-[54px]">
                    <div className="flex flex-wrap-reverse gap-10 items-start justify-center self-start mt-14  max-md:mt-10 max-md:max-w-full">
                        <div className="flex flex-col min-w-[240px] w-[701px] max-md:max-w-full  px-5">
                            <h1 className="text-3xl font-medium text-black max-md:max-w-full">
                                Sea Transport
                            </h1>
